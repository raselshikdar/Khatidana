    ...
    <footer className="mt-12 bg-primary text-primary-foreground">
      <div className="container py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-primary-foreground/70 mb-4">
              Bangladesh's premium destination for organic foods and grains. Pure, authentic, and naturally sourced.
            </p>
            <p className="text-sm text-primary-foreground/70 font-bengali">
              খাঁটিদানা - বাংলাদেশের সেরা জৈব খাদ্য ও শস্যের গন্তব্য
            </p>
          </div>
          ...
          {/* Customer Service */}
          <div>
            <h3 className="font-display font-semibold mb-4 text-lg">Customer Service</h3>
            <ul className="space-y-2 text-sm text-primary-foreground/70">
              ...
              <li><Link to="/payment-methods" className="hover:text-accent transition-colors">Payment Methods</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-primary-foreground/70">
              ...
              <li>
                <a href="tel:+8801700000000" className="flex items-center gap-2 hover:text-accent transition-colors">
                  <Phone className="h-4 w-4" />
                  <span>+880 1700 000000</span>
                </a>
              </li>
              <li>
                <a href="mailto:info@khatidana.com" className="flex items-center gap-2 hover:text-accent transition-colors">
                  <Mail className="h-4 w-4" />
                  <span>info@khatidana.com</span>
                </a>
              </li>
            </ul>
            ...
            <div className="flex gap-4 mt-4">
              <a 
                href="https://facebook.com/khatidana" 
                target="_blank" 
              ...
              <a 
                href="https://instagram.com/khatidana" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-primary-foreground/70 hover:text-accent transition-colors"
        ...
        <div className="border-t border-primary-foreground/10 pt-6 text-center text-sm text-primary-foreground/60">
          <p>© {new Date().getFullYear()} Khatidana (খাঁটিদানা). All rights reserved. Made with 🌱 in Bangladesh</p>
        </div>
      </div>
    </footer>
  );
