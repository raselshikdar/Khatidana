        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-6">
          <section className="bg-card p-6 rounded-xl border border-border">
            ...
            <p className="text-muted-foreground">
              By accessing and using Khatidana, you accept and agree to be bound by the terms and 
          ...
          <section className="bg-card p-6 rounded-xl border border-border">
            ...
            <p className="text-muted-foreground mb-3">
              You agree to use Khatidana only for lawful purposes. You are prohibited from:
            </p>
          ...
          <section className="bg-card p-6 rounded-xl border border-border">
            ...
            <p className="text-muted-foreground">
              Khatidana shall not be liable for any indirect, incidental, or consequential damages 
